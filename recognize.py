...
classifier = cv2.CascadeClassifier(r'C:\Users\Dell\Desktop\Face_Detction\haarcascade_frontalface_default.xml')

model = load_model(r"C:\Users\Dell\Desktop\Face_Detction\final_model.h5")
